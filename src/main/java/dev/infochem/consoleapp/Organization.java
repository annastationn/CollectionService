...
public class Organization {
    ...
    public Organization(Long id, String name, Coordinates coordinates, java.time.ZonedDateTime creationDate, float annualTurnover, OrganizationType type, Address officialAddress) {
        this.id = id;
        this.name = name;
